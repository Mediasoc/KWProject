...
public class Matrix {
	...
	public Matrix(int rows, int columns, double[] data) {
		this(rows, columns);
		assert (data.length == rows * columns);//�Ըò��������м�飬���󽫸���������˳�
		System.arraycopy(data, 0, this.data, 0, rows * columns);//Copies length elements from the array src, starting at offset srcPos, into the array dst, starting at offset dstPos. 
	}
	...
	public void setRandom() {
		for (int i = 0; i < rows * columns; i++) {
			data[i] = 10.0 * Math.random() - 5.0;//-5��5֮��������þ���Ԫ��ֵ
		}
	}

	public static Matrix identity(int rows, int columns) {//���������������������õ�λ����
	...
	public void setIdentity() {//���ݳ�Ա�������õ�λ����
		for (int j = 0; j < rows; j++)
			for (int i = 0; i < columns; i++) {
				if (i == j)
	...
	public static Matrix getRotationMatrix(double[] phi) {//��ת����
	...
	public double getValue(int i, int j) {//i���У�j���У�������ȡֵ��
