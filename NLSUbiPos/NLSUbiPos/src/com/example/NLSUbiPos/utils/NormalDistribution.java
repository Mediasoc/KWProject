...
public class NormalDistribution {
	/**
	 * Gets the value in the normal distribution according the given probability. 
	...
	/**
	 * Gets a random value which obeys standard normal distribution N(0,1).
	 * @return x where x~N(0,1)
	 */
	public static double randn() {
		return NormalDistribution.inverse(Math.random());
	}
}
